      ...
      >
        <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="font-display font-bold text-sm hidden sm:block group-hover:text-[#818CF8] transition-colors" style={{ color: 'var(--text-heading)' }}>
              Hitarth Parmar
            </span>
          </Link>
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  style={{
                    color: isActive ? '#6366F1' : 'var(--text-body)',
                  ...
                  >
                    <Link
                      ...
                      style={{
                        ...
                        color: isActive ? '#818CF8' : 'var(--text-body)',
                      }}
                    >
                      {link.label}
